...
import StartAccountForm from './StartAccount/StartAccountForm';
import CompleteAccountForm from './CompleteAccount/CompleteAccountForm';
...
class RegisterContainer extends Component {
  ...
  render() {
    if (this.state.step === 1) {
      return <StartAccountForm updateRegistration={this.updateRegistration} />;
    }

    if (this.state.step === 2) {
      return <CompleteAccountForm email={this.state.email} zip={this.state.zip} />;
    }
